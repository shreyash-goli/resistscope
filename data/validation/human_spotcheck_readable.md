# Faithfulness spot-check — grade each explanation 0 / 1 / 2

Compare the **AI explanation** against the **known mechanism** and score how well it captures the *primary structural mechanism*:

- **0** = contradicts the known mechanism
- **1** = consistent but vague / misses the key interaction
- **2** = correctly identifies the primary mechanism

Grade **blind** (the model's own scores are hidden in a separate key). When done, either fill the `human_score_0_1_2` column in the CSV, **or just reply to me** with a list like: `1:2, 2:1, 3:0, 4:2, ...`
...
**Known mechanism:** E138Q is a primary NNRTI-resistance mutation arising in both subtype B and C HIV-1. Based on published fold-change data, E138Q reduces rilpivirine susceptibility 5.4-fold and occurs more frequently in RT-experienced subtype C individuals. The Glu138 residue is located in the palm/catalytic core but does not directly contact NNRTI ligands; resistance likely arises from allosteric effects on the NNRTI-binding pocket geometry or from charge-neutralization (negative Glu to neutral Gln) altering local electrostatic stabilization of the binding cleft.

**AI explanation:** The E138Q mutation eliminates a negative charge at position 138 in the palm domain without directly contacting nevirapine, suggesting resistance operates through long-range electrostatic modulation rather than steric interference. The loss of glutamate's charged carboxylate likely disrupts an electrostatic network that maintains the precise geometry or conformational dynamics of the NNRTI-binding pocket ~43 Ångströms away, potentially weakening nevirapine accommodation through indirect effects on pocket architecture or protein flexibility. While the minimal binding affinity loss indicates this is a weak resistance mechanism, the charge neutralization may destabilize favorable electrostatic interactions that orient the inhibitor or stabilize the binding-competent RT conformation.
...
**Known mechanism:** Asn88 sits near the Asp30 / active-site loop and participates in a hydrogen-bonding network that positions Asp30. N88S disrupts this network and repositions the D30 loop, reducing binding of nelfinavir, atazanavir and indinavir.

**AI explanation:** The N88S mutation reduces nelfinavir binding through a subtle allosteric mechanism rather than direct contact: asparagine's larger polar side chain maintains a network of water-mediated interactions and conformational stability in the C-terminal dimer region, and its replacement with the smaller serine creates a local cavity that destabilizes the protease geometry without directly contacting the inhibitor. Although the mutation lies 7.3 Å from the ligand, this distal perturbation likely propagates conformational strain through the dimer interface, compromising the precise active site architecture required for optimal nelfinavir accommodation despite the relatively modest energetic penalty.
...
**Known mechanism:** Met46 is a flap residue that does not contact the inhibitor directly. M46I is an accessory flap mutation that alters flap dynamics and closure and compensates for active-site mutations, broadly contributing to PI resistance.

**AI explanation:** The M46I mutation at the flap region introduces a modest reduction in side-chain volume (3.8 Å³ smaller) while maintaining hydrophobicity, creating a small cavity that destabilizes the precise geometric fit required for indinavir binding in the protease active site. Although the mutation does not directly contact the ligand, its position 7 Å from indinavir influences the conformational dynamics and structural integrity of the flap—a critical mobile element that must adopt a specific conformation to optimally position the inhibitor and form stabilizing interactions through its neighboring residues. This subtle loss of van der Waals complementarity in the flap architecture weakly destabilizes the protease-inhibitor complex without introducing steric clashes or unfavorable electrostatic changes, resulting in the modest but measurable loss of binding affinity.
...
**AI explanation:** The E138A mutation shows negligible impact on nevirapine binding affinity (ΔΔG ≈ 0 kcal/mol), indicating this substitution does not materially weaken the drug-enzyme interaction. Located >43 Å from the ligand with no direct contacts and positioned in the palm catalytic core rather than the NNRTI allosteric pocket, residue 138 is too distant to significantly perturb nevirapine's binding geometry through steric or electrostatic mechanisms. The loss of glutamate's negative charge and the decrease in residue volume appear functionally inconsequential for NNRTI binding, suggesting E138A likely confers resistance—if clinically observed—through an indirect mechanism such as subtle alterations in protein conformational dynamics or thermodynamic stability rather than direct inhibitor displacement.
...
**Known mechanism:** The K101E substitution confers NNRTI resistance by disrupting a critical salt bridge interaction between K101 and E138 in the NNRTI binding pocket, which alters the structural geometry required for optimal NNRTI binding and stabilization. The charge reversal from a positively charged lysine to negatively charged glutamate at position 101 creates electrostatic repulsion with neighboring acidic residues or unfavorable contacts with the inhibitor, reducing binding affinity for multiple NNRTIs. K101E shows markedly heightened resistance to nevirapine and delavirdine while retaining some susceptibility to efavirenz, demonstrating selective NNRTI class resistance.

**AI explanation:** The K101E mutation eliminates a positively charged lysine and replaces it with a negatively charged glutamate that directly contacts nevirapine (2.7 Å minimum distance), disrupting favorable electrostatic interactions with the inhibitor's aromatic ring system while introducing an unfavorable charge repulsion. The simultaneous loss of ~30 Ų volume removes van der Waals contacts that stabilize the inhibitor's binding pose at the pocket rim, destabilizing the bound state through cumulative loss of both electrostatic and hydrophobic complementarity. This combined effect of charge inversion and reduced surface contact weakens nevirapine affinity despite the modest predicted energetic penalty, reflecting how rim residues fine-tune inhibitor binding through multiple weak interactions rather than dominant single contacts.
...
**Known mechanism:** The Y181V substitution reduces the volume of the NNRTI binding pocket (53.6 Ų decrease from Tyr→Val) and eliminates the aromatic π-stacking interaction that the tyrosine hydroxyl and ring normally provide for NNRTI ligands. This hydrophobic volume loss (particularly the loss of the bulky phenolic group) creates a cavity mismatch that substantially weakens NNRTI binding affinity, principally through loss of van der Waals contact and aromatic interactions, resulting in reduced binding dissociation constants and cross-resistance to multiple NNRTIs including nevirapine, efavirenz, and rilpivirine.

**AI explanation:** The Y181V mutation reduces nevirapine binding by eliminating critical aromatic interactions within the NNRTI pocket core. Tyrosine's large aromatic ring at this position makes direct van der Waals contacts with nevirapine (minimum distance 3.8 Å), and its hydroxyl group likely stabilizes the inhibitor through π-hydrogen bonding or favorable electrostatic interactions; valine's smaller, purely aliphatic side chain cannot replicate these contacts, resulting in a loss of binding affinity. The ~54 Ų decrease in side-chain volume creates a cavity within the tightly packed binding pocket, further destabilizing the ligand-protein interface and contributing to the measurable weakening of nevirapine binding.
...
**Known mechanism:** Val82 lines the S1 subpocket. Substituting the large aromatic phenylalanine (V82F) reshapes and constricts the subpocket, distorting the van der Waals packing against inhibitor P1 groups.

**AI explanation:** The V82F mutation introduces a bulky aromatic side chain (~50 Å³ larger) into the S1/S1' subpocket where atazanavir makes critical contacts, creating a steric clash that destabilizes the inhibitor's binding pose despite minimal distance separation (3.3 Å to nearest ligand atoms). The phenylalanine's rigid benzene ring cannot accommodate the same conformational flexibility as valine's branched aliphatic side chain, forcing atazanavir to adopt a suboptimal binding geometry that weakens van der Waals contacts and positioning of the inhibitor's anchor groups. Although the hydrophobicity decreases slightly, the entropic cost of constraining atazanavir's binding orientation outweighs any marginal hydrophobic gains, resulting in weaker overall binding affinity.
...
**AI explanation:** The M46I substitution in the flap region introduces a conformational rigidity that indirectly destabilizes atazanavir binding despite minimal volume change; methionine's longer, flexible side chain allows dynamic accommodation of the inhibitor's binding geometry, while isoleucine's branched, compact structure restricts the flap's conformational sampling needed to optimize van der Waals contacts with the ligand. At 7.0 Å minimum distance, residue 46 doesn't directly contact atazanavir but instead modulates flap positioning—the loss of methionine's conformational plasticity shifts the flap substate ensemble away from the optimal binding pose, reducing the overall complementarity and weakening inhibitor stabilization through entropic and indirect steric effects.
...
**AI explanation:** The E138A mutation shows negligible thermodynamic impact on efavirenz binding (ΔΔG ≈ 0), indicating this substitution does not substantially alter drug recognition. Located over 43 Ångströms from the ligand in the palm catalytic core—far beyond direct contact distance—E138 does not participate in critical inhibitor interactions; the loss of the glutamate's negative charge and bulky carboxylate side chain therefore has minimal energetic consequence for efavirenz positioning or binding geometry. This mutation likely represents a structurally neutral change that does not constitute a clinically relevant resistance mechanism through direct binding perturbation.
...
**AI explanation:** The L90M substitution reduces nelfinavir binding through a subtle allosteric mechanism rather than direct contact disruption. Although leucine-to-methionine maintains overall hydrophobicity and creates minimal volume loss (~3.8 Ų), the introduction of the polar sulfur atom in methionine's thioether side chain and its decreased hydrophobic character (-1.9 shift) destabilizes the precise hydrophobic packing environment within the C-terminal dimer interface region, which propagates conformational strain toward the active site 8.2 Å away. This indirect effect slightly compromises the protease's conformational stability or substrate binding groove geometry in a manner that preferentially weakens nelfinavir accommodation without completely abolishing binding capacity.
